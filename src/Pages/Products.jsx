    ...
    <Grid display="flex" flexDirection="column">
      <Box position="relative" height="10vh" display="flex" flexDirection="column">
        ...
        >
          ...
          <Button onClick={() => route("/checkout")} variant="contained" sx={{ height: "100%", bgcolor: "#498A19" }}>
        ...
        >
          {paquages.map((e) => (
            <>
              <Grid display="flex" position="relative" alignItems="center" justifyContent="space-between" width="100%">
                <Box
                  display="flex"
                  ...
                  <CardActionArea sx={{ padding: 2 }}>
                    <Grid display="flex" flexDirection="column" justifyContent="center" alignItems="flex-start">
                      ...
                      <Button
                        width="100%"
                        sx={{
                          backgroundColor: e.paquete === "Premium" ? "#D0A723" : "primary.main",
                          color: "white",
                        }}
                      ...
                      <Typography sx={{ color: e.paquete === "Premium" ? "#D0A723" : "primary.main", fontSize: 12 }}>
