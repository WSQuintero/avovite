  ...
  return (
    <>
      <Button
        ...
        size="large"
        type="submit"
        sx={{ width: "130px", fontSize: "12px", position: "absolute", right: "10px", top: "10px" }}
      >
        Ir al final
      </Button>
      ...
      >
        ...
        <p>
          ...
          Vites: adquirir los frutos del cultivo de aguacate y productos complementarios. Al comprometerse con un "vite" mediante un
          contrato de compra de cosa futura, los clientes aseguran una fracción equivalente a la producción de futuras cosechas de un árbol,
          con derechos que pueden extenderse hasta 20 año.
        </p>
        <p>
          <span>
            <span>
        ...
        <p>
          ...
          <strong>Comercializadores:</strong> Terceros autorizados que tienen la capacidad de ofertar y comercializar las cosechas de
          aguacate y productos complementarios en nombre de Avovite.
        </p>
        <p>
          <span>
            <span>
        ...
        <p>
          ...
          Participación en Decisiones: Especifica cómo los participantes pueden contribuir en decisiones clave relacionadas con la
          plataforma.
        </p>
        ...
        <p>
          Avovite se compromete a ofrecer servicios que abarquen desde la adquisición de "vites" hasta la gestión de cosechas, garantizando
          a los usuarios una experiencia integral en la plataforma.
        </p>
        <p>
          <span>&nbsp;</span>
        </p>
        ...
        <p>
          Para acceder y utilizar la plataforma, los usuarios deben cumplir con los requisitos de elegibilidad establecidos por Avovite.
          Esto puede incluir, entre otros, la capacidad legal para participar en transacciones.
        </p>
        ...
        <p>
          Se espera que los usuarios utilicen la plataforma de manera ética y respetuosa. Se establecerán prácticas aceptables para
          garantizar un entorno de interacción positivo y seguro.
        </p>
        ...
        <p>
          Además de "vites," Avovite podrá ofrecer otros productos agrícolas. Los detalles sobre estos productos adicionales se
          proporcionarán en la plataforma a medida que estén disponibles.
        </p>

        <p>2.9 Pagos:</p>
        <p>
          Los procedimientos de pago, facturación y la política de retrasos o serán detallados para la comprensión clara de los usuarios.
        </p>
        ...
        <p>
          ...
          Avovite. Este contrato rige la relación durante la adquisición de "vites" y otros producto asi como<span>&nbsp;</span>en el uso y
          la participación en otras funciones de la plataforma.
        </p>
        <p>
          <span>
            <span>
        ...
        <p>
          ...
          Requisitos Adicionales: Avovite puede establecer requisitos adicionales para la adquisición de "vites" o participación en
          funciones específicas de la plataforma. Estos requisitos serán comunicados de manera clara y oportuna.
        </p>
        <p>
          <span>
            <span>
        ...
        <p>
          ...
          Conservación de Documentos: La aceptación de los términos y condiciones implica el consentimiento para la conservación de
          documentos electrónicos que respalden la transacción y la relación contractual.
        </p>
        ...
        <p>
          El usuario utilizará la plataforma y participará en transacciones de manera ética y legal. Se compromete a no utilizar la
          plataforma con fines ilegales, fraudulentos o inapropiados.
        </p>
        ...
        <p>
          El usuario reconoce y acepta los riesgos asociados con la adquisición de "vites" y otros productos, incluyendo factores
          climáticos, fluctuaciones de mercado y eventos imprevistos que puedan afectar la producción.
        </p>
        ...
        <p>
          ...
          detallarán los procedimientos, plazos de pago y cualquier otro aspecto relevante para estas transacciones las cuales se euentran
          en el contrato que el usuario “Cliente” se compromete a firmar.
        </p>

        <p>6.3 Responsabilidad de Pago:</p>
        <p>
          Los usuarios asumen la responsabilidad de cumplir con los pagos asociados a la adquisición de "vites" y otros productos
          disponibles en la plataforma. La falta de pago puede resultar en la cancelación del contrato y otras acciones legales según lo
        ...
        <p>
          ...
          comercializar los productos adquiridos a través de la plataforma. Esta autorización se extiende a terceros, como
          comercializadores, en la medida en que sea necesario para cumplir con las obligaciones del contrato.
        </p>
        ...
        <p>
          ...
          relacionadas con el cultivo y comercialización, los usuarios reconocen y aceptan que dichos terceros actuarán en nombre de Avovite
          y estarán sujetos a las disposiciones pertinentes de estos términos y condiciones.
        </p>
        ...
        <p>
          ...
          Los usuarios se comprometen a utilizar la plataforma de manera ética y legal. Cualquier uso que viole leyes aplicables, normativas
          o estos términos y condiciones está estrictamente prohibido.
        </p>
        <p>
        ...
        <p>
          ...
          proporcionada durante el proceso de adquisición y en cualquier interacción con la plataforma. Cualquier información falsa o
          engañosa puede resultar en la cancelación del contrato.
        </p>
        <p>
        ...
        <p>
          9.2 <strong>Cancelación por Incumplimiento:</strong> Avovite se reserva el derecho de cancelar la participación de un usuario en
          la plataforma si se determina que han violado los términos y condiciones. Esto puede ocurrir en casos de conducta inapropiada,
        ...
        <p>
          10.1 <strong>Recopilación de Información:</strong> Avovite recopilará y procesará la información personal de los usuarios de
          acuerdo con su política de privacidad y en conformidad con la Ley de Protección de Datos Personales (Ley 1581 de 2012). Los
          usuarios deben revisar y aceptar esta política para utilizar la plataforma.
        </p>
        <p>
        ...
        <p>
          10.6 <strong>Uso Comercial y Otros Productos:</strong> Al aceptar estos términos y condiciones, los usuarios consienten el uso de
          su información personal con fines comerciales por parte de Avovite y la posibilidad de recibir ofertas y comunicaciones sobre
          otros productos o servicios ofrecidos por la plataforma, la empresa y/o empresas vinculadas.
        </p>
        <Subtitle index="11">Propiedad Intelectual:</Subtitle>
        <p>
          11.1 <strong>Derechos de Propiedad:</strong>
          Todo el contenido, diseño, marcas registradas, y propiedad intelectual asociada a la plataforma son propiedad exclusiva de
          Avovite. Los usuarios reconocen y respetan estos derechos y se comprometen a no copiar, reproducir ni utilizar dicho contenido de
          manera no autorizada.
        </p>
        <p>
          11.2 <strong>Licencia de Uso:</strong>
          Avovite otorga a los usuarios una licencia limitada, no exclusiva e intransferible para utilizar la plataforma con fines
          personales y no comerciales. Esta licencia no implica la transferencia de derechos de propiedad.
        </p>
        <p>
        ...
        <p>
          ...
          información marcada expresamente como confidencial. Se comprometen a no divulgar, reproducir o utilizar dicha información para
          fines ajenos al acuerdo establecido.
        </p>
        <p>
          12.2 <strong>Alcance de la Confidencialidad:</strong> La obligación de confidencialidad abarca, pero no se limita a, la
          información mencionada en el punto 12.1.
        </p>
        <p>
          12.3 <strong>Excepciones:</strong> La obligación de confidencialidad no se aplica a información que sea de conocimiento público,
          que el usuario ya poseía antes de acceder a la plataforma, o que sea revelada conforme a requisitos legales.
        </p>
        <p>
        ...
        <p>
          13.2 <strong>Información y Asesoramiento Fiscal:</strong> Avovite no proporciona asesoramiento fiscal. Se recomienda a los
          usuarios buscar asesoramiento profesional independiente sobre cuestiones fiscales relacionadas con sus transacciones en la
          plataforma.
        </p>
        <p>
          13.3 <strong>Registro y Reporte:</strong>
          Los usuarios deben cumplir con los requisitos de registro y reporte establecidos por las autoridades fiscales correspondientes en
          su jurisdicción.
        </p>
        <p>
        ...
        <p>
          14.1 <strong>Asesoramiento Independiente:</strong> Los usuarios reconocen que Avovite no proporciona asesoramiento financiero,
          legal ni de otro tipo. Se recomienda a los usuarios buscar asesoramiento independiente antes de tomar decisiones basadas en la
          información proporcionada por la plataforma.
        </p>
        <p>
          14.2 <strong>Riesgos y Decisiones:</strong>
          Los usuarios asumen la responsabilidad de evaluar los riesgos asociados con las transacciones y decisiones tomadas en la
          plataforma. Avovite no garantiza resultados específicos y no es responsable de las consecuencias derivadas de las decisiones de
          los usuarios.
        </p>
        <p>
          14.3 <strong>Información Informativa:</strong>
          Cualquier información proporcionada por Avovite, ya sea en la plataforma, documentos relacionados o comunicaciones, se presenta
          con fines informativos y no constituye asesoramiento profesional.
        </p>
        ...
        <p>
          ...
          caso de pérdidas cubiertas por pólizas de seguros vigentes, Avovite se compromete a gestionar las reclamaciones de manera oportuna
          y utilizar los fondos recuperados para reactivar el cultivo o los cultivos complementarios, en su defecto como indenisación de las
        ...
        <p>
          Avovite puede proporcionar enlaces a sitios web de terceros u otras fuentes de información. Los usuarios reconocen que estos
          enlaces se proporcionan solo con fines informativos y conveniencia. Avovite no respalda, controla ni garantiza la precisión,
          integridad, relevancia o actualidad de la información disponible en estos sitios web de terceros. Al acceder a dichos enlaces, los
          usuarios asumen la responsabilidad de evaluar la información y aceptan que Avovite no será responsable de pérdidas o daños
        ...
        <p>
          ...
          productos ofrecidos por Avovite. Es responsabilidad del usuario mantener actualizada su información de contacto. Avovite no se
          hace responsable de las consecuencias derivadas de la falta de recepción de comunicaciones debido a información desactualizada.
        </p>
        <Subtitle index="18">Facturación Electrónica:</Subtitle>
        <p>
          Los usuarios aceptan y autorizan la emisión de facturas electrónicas por parte de Avovite, las cuales se enviarán a la dirección
          de correo electrónico proporcionada durante el proceso de registro. Es responsabilidad del usuario asegurarse de que la
          información de contacto y facturación sea precisa y esté actualizada. Avovite se reserva el derecho de utilizar medios
          electrónicos para la facturación y documentación asociada, promoviendo así prácticas sostenibles y amigables con el medio
          ambiente.
        </p>
        ...
        <p>
          ...
          que no entren en conflicto, y cualquier discrepancia significativa será notificada a los usuarios de manera oportuna, en caso de
          que tal de que eexista diferencias en la interpretación se utilizara la conciliación y la buena fé de las partes para remediar las
          discrepencias.
        </p>
        <Subtitle index="20">Sucesores y Cesionarios:</Subtitle>
        <p>
          Avovite se reserva el derecho de ceder total o parcialmente los derechos y obligaciones derivados de estos términos y condiciones
          a un tercero, ya sea en el contexto de una fusión, adquisición o cualquier otro cambio en la estructura corporativa. En caso de
          que dicha cesión ocurra, los usuarios aceptan que el beneficiario de esta cesión asumirá todas las obligaciones y
          responsabilidades establecidas en estos términos y condiciones. Del mismo modo, los usuarios tienen el derecho de designar
          beneficiarios en sus contratos individuales, y en caso de fallecimiento, los derechos y beneficios se transferirán conforme a las
          disposiciones establecidas en dichos contratos.
        </p>
        ...
        <p>
          Las disposiciones y términos que, por su naturaleza, deban sobrevivir a la terminación o expiración de estos términos y
          condiciones, permanecerán en pleno vigor y efecto, incluidos, entre otros, los apartados de Confidencialidad, Limitación de
          Responsabilidad, Propiedad Intelectual, Ley Aplicable y Solución de Controversias.
        </p>
        ...
        <p>
          Estos términos y condiciones entrarán en vigencia a partir de la fecha de aceptación por parte del usuario y permanecerán en
          efecto hasta su modificación o terminación por cualquiera de las partes. Avovite se reserva el derecho de modificar estos términos
          y condiciones en cualquier momento, notificando a los usuarios de dichos cambios con anticipación.
        </p>
        ...
        <p>
          ...
          condiciones de adquisición, se proporcionará en la plataforma y estará sujeta a estos términos y condiciones. Y{" "}
          <span>&nbsp;</span>
        ...
        <p>
          ...
          proporcionar una descripción clara y detallada de este proceso, así como a brindar asistencia en caso de preguntas o
          inconvenientes durante la adquisición.
        </p>
        ...
        <p>
          30.1. Cuidado, Cultivo y Cosecha: Avovite se compromete a cuidar, cultivar y cosechar los árboles, cultivos y productos asociados
          de manera diligente y profesional, asegurando la calidad y cantidad esperadas.
        </p>
        <p>
        ...
        <p>
          ...
          Avovite permitirá a los usuarios elegir entre recibir directamente los frutos o autorizar la gestión de ventas a través de
          terceros, como comercializadores. Se brindará información clara sobre ambas opciones.
        </p>
        ...
        <p>
          ...
          Se brinda una descripción detallada de la plataforma online de Avovite, incluyendo sus características, funcionalidades y
          servicios ofrecidos. Esto garantiza que los usuarios comprendan completamente el entorno en el que participan.
        </p>
        <p>
        ...
        <p>
          ...
          funcionalidades y servicios ofrecidos. Con el objetivo de brindar una comprensión completa a los usuarios, se detallan las
          distintas secciones y herramientas disponibles en la plataforma:
        </p>
        <p>
          31.1.1. <strong>Compra de "Vites":</strong> - Explicación detallada del proceso de adquisición de "vites" y los derechos
          asociados. - Información sobre cómo los usuarios pueden participar en el proceso de compra y las consideraciones clave.
        </p>
        <p>
        ...
        <p>
          31.1.5. <strong>Transacciones:</strong> - Descripción de la sección que registra todas las transacciones realizadas,
          proporcionando a los usuarios un historial claro de sus actividades.
        </p>
        <p>
        ...
        <p>
          ...
          Avovite se reserva el derecho de realizar actualizaciones y mejoras en la plataforma para garantizar su eficiencia y seguridad.
          Los usuarios serán notificados con anticipación sobre cualquier cambio significativo.
        </p>
        <p>
        ...
        <p>
          32.1. <strong>Recepción Directa por Parte del Usuario:</strong> Los usuarios tendrán la opción de recibir directamente los frutos
          y productos de sus adquisiciones. Se especificarán los procedimientos logísticos, plazos y cualquier requisito relacionado con
          esta opción.
        </p>
        <p>
          ...
          frutos a través de terceros, como comercializadores u otros socios. En este caso, se proporcionará información detallada sobre
          cómo se llevará a cabo este proceso y cómo se distribuirán las ganancias.
        </p>
        <p>
        ...
        <p>
          ...
          Los usuarios pueden tener la flexibilidad de cambiar su elección en cuanto a la recepción de los frutos, siempre y cuando se
          cumplan ciertos requisitos y condiciones que se establecerán en esta sección.
        </p>
        <p>
          32.5. <strong>Comunicación de Elecciones:</strong>
          Procedimientos claros sobre cómo los usuarios deben comunicar sus elecciones, ya sea la recepción directa o la gestión de ventas
          por parte de Avovite, para garantizar una coordinación efectiva.
        </p>
        <p>
        ...
        <p>
          ...
          cosechas y otros productos adquiridos a través de la plataforma. Para garantizar eficiencia y transparencia, se han establecido
        ...
        <p>
          33.2. Retiros Manuales: En casos excepcionales que requieran intervención manual, la empresa se compromete a completar el proceso
          de retiro en un plazo máximo de 7 días hábiles a partir de la solicitud del usuario.
        </p>
        <p>
        ...
        <p>
          ...
          solicitudes de retiro. Estas notificaciones incluirán confirmaciones de procesamiento automático, aprobaciones manuales y
          cualquier información relevante para el usuario.
        </p>
        <p>
          <strong>33.6. Implicaciones Fiscales: </strong>Se proporcionará información básica sobre las implicaciones fiscales relacionadas
          con los retiros. Sin embargo, se recomienda a los usuarios buscar asesoramiento profesional para comprender completamente sus
        ...
        <p>
          ...
          Se proporciona una descripción clara de las colaboraciones existentes o futuras con terceros. Esto puede incluir, pero no
          limitarse a, empresas comercializadoras, aliados estratégicos, proveedores de servicios, entre otros.
        </p>
        <p>
        ...
        <p>
          ...
          Avovite establece claramente que la responsabilidad en las colaboraciones con terceros está limitada a lo acordado en los términos
          y condiciones. Los usuarios comprenden y aceptan que las transacciones o interacciones con terceros están regidas por las
        ...
        <p>
          ...
          asume responsabilidad directa por cualquier falla, interrupción o problema técnico causado por los proveedores tecnológicos. En
          caso de eventos fuera del control directo de Avovite, como fallas en servidores de terceros, problemas de red o interrupciones en
        ...
        <p>
          ...
          conscientes de que la pérdida de datos debido a fallas de proveedores tecnológicos puede estar fuera del control directo de
          Avovite.
        </p>
        <p>
        ...
        <p>
          ...
          En caso de problemas técnicos relacionados con proveedores tecnológicos, Avovite se compromete a cooperar y facilitar la
          resolución de problemas en la medida de lo posible. Sin embargo, la resolución final puede depender de las políticas y acciones de
          los proveedores tecnológicos involucrados.
        </p>
        ...
        <p>
          ...
          Personales (Ley 1581 de 2012) y normativas relacionadas. Los usuarios aceptan que, al proporcionar información personal, están
          dando su consentimiento para el tratamiento de dicha información de acuerdo con la política de privacidad de Avovite.
        </p>
        <p>
        ...
        <p>
          37.5. <strong>Modificaciones Legales:</strong> En caso de cambios en la legislación colombiana que afecten directamente los
          términos y condiciones de uso de la plataforma, Avovite se reserva el derecho de realizar ajustes correspondientes. Los usuarios
          serán notificados de cualquier modificación en cumplimiento con los procesos establecidos en estos términos y condiciones.
        </p>
        <p>
        ...
        <p>
          ...
          autoridades competentes para garantizar el cumplimiento de la ley. Esto puede incluir la divulgación de información pertinente
          según las solicitudes legales y procesos judiciales.
        </p>
        <p>
