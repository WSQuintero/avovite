...
function UploadPhotosButton({ isChangeInformationUser, setFrontalImage, setTraseraImage, frontalImage, traseraImage }) {
  ...
  return (
    <>
      {isChangeInformationUser && (
        <>
          <Button onClick={handleOpen} variant="outlined" >Subir documento de identificación</Button>
          <Modal
            open={open}
            onClose={handleClose}
