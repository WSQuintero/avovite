...
import { FormControl, Icon, IconButton, MenuItem, Select, Stack, Typography } from "@mui/material";
    ...
    <PageWrapper collapseSidebar="admin">
      ...
      <FormControl >
        ...
        >
          ...
          <MenuItem value={'changeBeneficiary'}>
            Cambiar información de beneficiario
          </MenuItem>
          <MenuItem value={'changeBankInfo'}>
